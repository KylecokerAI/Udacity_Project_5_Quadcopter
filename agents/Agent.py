...
from agents.Replay_Buffer import Replay_Buffer
...
class DDPG():
    ...
    def __init__(self, task):
        ...
        self.exploration_theta = 0.15 # radians 
    ...
    def act(self, state): 
        ...
        action_with_noise = list(action + noise)
    ...
    def learn(self, experiences):
        ...
        #   element (states, actions, rewards, etc.)
        ...
        # Get predicited next-state actions and Q values from target models 
